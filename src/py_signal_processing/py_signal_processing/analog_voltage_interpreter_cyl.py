...
class SensorInterpreterNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('v0_pressure_pam', 1.003939)
        self.declare_parameter('v0_pressure_pam_valve', 0.983037)
        self.declare_parameter('v0_pressure_supply', 0.988248)
